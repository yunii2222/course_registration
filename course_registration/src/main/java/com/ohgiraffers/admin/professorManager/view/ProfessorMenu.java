...
import java.util.Scanner;
    ...
    public class ProfessorMenu {
        ...
        private SearchCondition inputSearchCondition() {
            ...
            System.out.println("============================");
            System.out.println("1.학생이름으로 조회");
            System.out.println("2.학생 연락처로 조회");
            System.out.println("3.학생 전공 코드로 조회");
            System.out.println("===================================");
            ...
            switch (selectMenu){
                ...
                case 2 :
                    ...
                    System.out.println("조회할 학생 연락처를 입력해주세요");
                    System.out.print("=> ");
                    value = sc.nextLine();
                    break;
                case 3 :
                    sc.nextLine();
                    option = "subjectCode";
                    System.out.println("조회할 학생 전공 코드를 입력해주세요");
                    System.out.print("=> ");
                    value = sc.nextLine();
                    break;
                default : System.out.println("잘못된 번호입니다. 확인 후 다시 입력해 주세요."); break;
